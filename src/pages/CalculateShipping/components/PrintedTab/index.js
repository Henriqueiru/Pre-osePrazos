...
function PrintedTab({
  ...
  useMemo(() => {
    const { printed } = calculateShipping;

    setObjectFormat(printed.objectFormat);
    setServiceFurther(printed.additionalService);

    setTimeout(() => {
      formRef.current.setData({ ...printed });
    }, 500);
  ...
  function handleChangeSwitchServiceFurther(event) {
    ...
    if (name === 'lowcostRegistry') {
      service = { [name]: checked, nationalRegistry: false };
    ...
    } else if (name === 'nationalRegistry') {
      service = { [name]: checked, lowcostRegistry: false };
    ...
    setServiceFurther({ ...serviceFurther, ...service });
  }
        ...
        .shape({
          ...
          dimensions: Yup.object()
            ...
            .when('objectFormat', {
              ...
              then: Yup.object().shape({
                diameter: Yup.number()
                  .typeError('De 3,5 a 90 cm')
                  .min(3.5, 'De 3,5 a 90 cm')
                  .max(90, 'De 3,5 a 90 cm'),
                length: Yup.number()
                  .typeError('De 3,5 a 90 cm')
                  .min(3.5, 'De 3,5 a 90 cm')
                  .max(90, 'De 3,5 a 90 cm'),
            ...
            .when('objectFormat', {
              ...
              then: Yup.object().shape({
                length: Yup.number()
                  .typeError('De 14 a 60 cm')
                  .min(14, 'De 14 a 60 cm')
                  .max(60, 'De 14 a 60 cm'),
                width: Yup.number()
                  .typeError('De 9 a 60 cm')
                  .min(9, 'De 9 a 60 cm')
                  .max(60, 'De 9 a 60 cm'),
              }),
            }),
        ...
        .test('calculations', function calculations(value) {
          ...
          const calculationValidation = {
            ...
            2() {
              ...
              return sum <= 104 && (length >= 10 || diameter >= 10);
            },
            3() {
          ...
          if (!valid && value.objectFormat === 1) {
            return element.createError({
              ...
              message: 'Soma das dimensões: máximo 150 cm',
            });
          }

          if (!valid && value.objectFormat === 2) {
            if (diameter < 10 && length < 10) {
              return element.createError({
                path: 'dimensions.diameter',
                message: 'Uma das medidas precisa ter no mínimo 10 cm',
              });
            }

            return element.createError({
              path: 'dimensions.diameter',
              message: 'Comprimento + dobro do diâmetro: entre 17 e 104 cm',
            });
          }
          ...
          if (!valid && value.objectFormat === 3) {
            return element.createError({
              ...
              message: 'Soma das dimensões: máximo 90 cm',
            });
          }
  ...
  function assembleParametersForAPI() {
    ...
    if (additionalService.lowcostRegistry) {
      params += '&nCdServico=10162,20419,20397';
    } else if (additionalService.nationalRegistry) {
      params += '&nCdServico=10154,20362,20370';
    } else {
      params += '&nCdServico=10014,20010,20214';
    }
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={6}>
          <Select className={classes.fullWidth} label="Peso" name="weight">
            <MenuItem value={0.19}>Até 20 g</MenuItem>
            <MenuItem value={0.49}>Até 50 g</MenuItem>
            <MenuItem value={0.99}>Até 100 g</MenuItem>
            <MenuItem value={0.149}>Até 150 g</MenuItem>
            <MenuItem value={0.199}>Até 200 g</MenuItem>
            <MenuItem value={0.249}>Até 250 g</MenuItem>
            <MenuItem value={0.299}>Até 300 g</MenuItem>
            <MenuItem value={0.349}>Até 350 g</MenuItem>
            <MenuItem value={0.399}>Até 400 g</MenuItem>
            <MenuItem value={0.449}>Até 450 g</MenuItem>
            <MenuItem value={0.499}>Até 500 g</MenuItem>
            <MenuItem value={0.549}>Até 550 g</MenuItem>
            <MenuItem value={0.599}>Até 600 g</MenuItem>
            <MenuItem value={0.649}>Até 650 g</MenuItem>
            <MenuItem value={0.699}>Até 700 g</MenuItem>
            <MenuItem value={0.749}>Até 750 g</MenuItem>
            <MenuItem value={0.799}>Até 800 g</MenuItem>
            <MenuItem value={0.849}>Até 850 g</MenuItem>
            <MenuItem value={0.899}>Até 900 g</MenuItem>
            <MenuItem value={0.949}>Até 950 g</MenuItem>
            <MenuItem value={0.999}>Até 1 Kg</MenuItem>
            <MenuItem value={1.999}>Até 2 Kg</MenuItem>
          </Select>
        </Grid>
      </Grid>
          ...
          >
            ...
            <AccordionDetails className={classes.accordionDetails}>
              <Scope path="additionalService">
                <FormGroup>
                  <FormControlLabel
                    label="Registro Módico"
                    control={
                      <Switch
                        name="lowcostRegistry"
                        checked={!!serviceFurther.lowcostRegistry}
                  ...
                  <FormControlLabel
                    ...
                    control={
                      <Switch
                        ...
                        checked={!!serviceFurther.nationalRegistry}
                        onChange={handleChangeSwitchServiceFurther}
                      />
                    }
                  />
                  ...
                  <FormControlLabel
                    ...
                    control={
                      <Switch
                        ...
                        disabled={
                          !serviceFurther.lowcostRegistry &&
                          !serviceFurther.nationalRegistry
                        }
                        onChange={handleChangeSwitchServiceFurther}
                      />
                    }
